...
<section>
	<h4 style="text-align:center">Bid  History</h4>
	<div class="panel panel-default">
	  ...
	  <table class="table">
		...
		<?php
			...
			//$user="tly787";
			$sql = 'CALL getListOfBidsMoney(:buyer)';
			...
			foreach($fetch as $row )
			{
				...
				{
					$final = 'Your bid has been rejected. If the book is still for sell you may submit a new offer';
				}
