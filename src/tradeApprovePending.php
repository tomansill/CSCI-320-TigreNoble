...
<section>
	<h4 style="text-align:center">Trades(s) pending approval by you </h4>
	<div class="panel panel-default">
	  ...
	  <table class="table">
		...
		<?php
			...
			$sql = 'CALL getListOfBidsTradeSellerWithMoreInfo(:dce)';
	...
	<div style="display:none">
		<form method="post" class="tranForm" action="updateTrade.php" >
